...
foreach ($locale_codes as $locale_code) {
	// TODO figure out why this is not picked up by the web service ('HTTP/1.1 400 Bad Request. locale_code is required')
	$params['locale_code'] = $locale_code;
	$result = $client->post('document/{document_id}/translation', $params, $headers);
